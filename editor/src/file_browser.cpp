...
{
    m_directoryIcon = ResourcesManager::LoadTexture("editor/assets/DirectoryIcon.png", true);
    m_fileIcon = ResourcesManager::LoadTexture("editor/assets/FileIcon.png", true);
}
